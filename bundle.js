...
var links =['link href="https://fonts.googleapis.com/css?family=Ubuntu',
...
minixhr('https://api.github.com/users/bulevarbulevar9', startPage)
...
<div>
    <img src ="${data.avatar_url}">
     ...
     <h3>${data.bio}</h3>
     <div>
        <i class = "${css.arrow} fa fa-chevron-down" aria-hidden = "true"></i>            </div>
   ${portfolioComponent()}
   ${textboxComponent()}
   ${footerComponent()}
</div>
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/bulevarbulevar9">
